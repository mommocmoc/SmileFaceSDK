...
using OpenCVCompact.CoreModule;
using System;
...
namespace OpenCVCompact
{
    ...
    public class Imgproc
    {
        ...
        private const int RETR_EXTERNAL = 0;
        private const int RETR_LIST = 1;
        private const int RETR_CCOMP = 2;
        private const int RETR_TREE = 3;
        private const int RETR_FLOODFILL = 4;
