...
namespace OpenCVCompact
{
     ...
     */
    public class Net : DisposableOpenCVCompactObject
    {
        ...
        public void forward(List<Mat> outputBlobs, List<string> outBlobNames)
        {
            ...
            dnn_Net_forward_14(nativeObj, outputBlobs_mat.nativeObj, outBlobNames.ToArray(), outBlobNames.Count);
            Converters.Mat_to_vector_Mat(outputBlobs_mat, outputBlobs);
            //UnityEngine.Debug.Log("forward HERE - 1");

            outputBlobs_mat.release();
            //UnityEngine.Debug.Log("forward HERE - 2");
        ...
        // C++:  void cv::dnn::Net::forward(vector_Mat& outputBlobs, vector_String outBlobNames)
        [DllImport(LIBNAME)]
        private static extern void dnn_Net_forward_14(IntPtr nativeObj, IntPtr outputBlobs_mat_nativeObj, string[] outBlobNames, int outBlobNames_size);
