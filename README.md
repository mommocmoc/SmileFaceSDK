...
<h3 align="center">SmileFace SDK</h3>
  ...
  <p align="center">
  Keyboard, mouse, and other console controllers are designed to fit our hands. 
    Not everyone, however, is fully enjoying games with such controllers. 
    What do you think of building a game enjoyed by many more, using a kit that enables people to play games with facial motions and expressions on Unity engine?
     <br />
    ...
    <br />
    <a href="https://github.com/mommocmoc/SmileFaceSDK"><strong> 자세히 살펴보기(Features)</strong></a>
    <br />
    <br />
    <a href="https://indie.onstove.com/ko/games/780"> 데모(Demo)</a>
    ·
    <a href="https://github.com/mommocmoc/SmileFaceSDK/issues">버그 제보(Bug Report)</a>
    ·
    <a href="https://github.com/mommocmoc/SmileFaceSDK/issues">추가 기능 & 협업 제안(Additional Feature & Collab suggestion)</a>
  </p>
</div>
...
<details>
  ...
  <ol>
    ...
    <li>
      ...
      <ul>
        <li><a href="#Unity-버전-관련-정보">Unity 버전 관련 정보(Unity Version)</a></li>
<!--         <li><a href="#installation">설치하기(Installation)</a></li> -->
      </ul>
    </li>
    <li><a href="#사용법">사용법(How to use)</a></li>
<!--     <li><a href="#roadmap">Roadmap</a></li> -->
    <li><a href="#프로젝트에-기여하기">프로젝트에 기여하기(Contribution)</a></li>
    <li><a href="#license">라이센스(License)</a></li>
    <li><a href="#contact">문의&협업(Contact)</a></li>
    <li><a href="#acknowledgments">감사의 말(Acknwledgments)</a></li>
  </ol>
</details>
...
- I release SmileFace SDK as an open-source project, hoping more people get to play and enjoy games with a webcam and facial expressions apart from hands, which are the most dominant tool used to play games. 
...
### How it Started - 개발 배경
It all started back in 2017. In interactive design class, I wanted to make something using facial recognition for the first time. I thought of building an instrument played by facial motion, but it wasn’t much fun… So, I developed a simple game using a face controller in which the user had to overcome much pain and feel accomplished(?) like <Getting over It with Bennett Foddy> which was all over the internet back then. ‘I’m going to launch this game!’ was the last thought and somehow 3 years have passed... (BA-BAM) Here I am working at Smilegate.
...
#### Meeting Smilegate’s internal creator support programs ‘Creative Challengers League’ & ‘Masters League’.
- 사내 창작 지원 프로그램 Creative Challenger's League, Master's League를 만나다.

In my first year at Smilegate… I came across a program called CCL. My manager said it would be a good idea to join the program since nobody from our department ‘Smilegate Foundation’ has done so yet. So, to newly develop the face controller game, I decided to take the challenge. For 3 months of CCL, I was able to build a prototype and with the prototype shoot for the next stage of CCL, ML.
...
#### I tried to develop a game played with face, wishing people would become happier with more laughter, in today’s world where people have less and less to smile about.

#### 웃음이 적어지는 세상에, 더 많이 웃으며 행복해지길 바라는 마음으로 얼굴로 즐기는 게임을 개발하려고 했습니다.

I think the very essence of game is fun. So, I put a lot of thought into developing a game that is played with laughter, alone and together. But having to work full time and developing a game at the same time wasn’t easy. I had to do everything on my own from level design to art, sound, and programming while lacking experience in actual game development. I felt that I wasn’t quite ready for it. So under my mentor(Seunghwan Yeo)’s advice, I changed my plan and decided to build a face controller for creators to easily apply face control to their games and release it as an open-source project. Building a kit for other creators instead of developing my own game got me even more excited.
...
#### So, I’d like to work together with any game developer who’s interested in looking into the potential of this new alternative controller, SmileFaseSDK. 
If we can play games with our face, I believe more people will enjoy game. 
...
I’m still developing a game called ‘Smileface.Legend’ using SmileFace SDK. For those who may be curious about what kind of game can be built using this SDK, I’ve also uploaded a simple demo game. I’d like to meet with game developers who want to make games with new ideas using facial motions and expressions.
...
- [얼굴로 총알 피하기 데모](https://indie.onstove.com/ko/games/780) | [Demo Game] Avoiding Bullets with Face! 
- [대학생 때, 얼굴로 연주하는 악기 만드려던 시도..ㅎㅎ](https://youtu.be/GARD7_ik7yE) | Trying to make an instrument played by face!
- [웃상.전설 CCL 프로토타입 영상](https://youtu.be/YoOU4lEbE3k) | Smileface.Legend – CCL Prototype Video!
- [웃상.전설 ML 버전 데모 영상](https://youtu.be/WTc1ntseUgc) | Smileface.Legend– ML version Video!

<!-- GETTING STARTED -->
## Getting Started - 시작하기

Install through Unity Package Manager with this Git URL or [download][unitypackagefile-url] the Unitypackage file.

Unity Package Manager에서 본 Git URL을 통해 설치하거나, Unitypackage 파일을 [다운로드][unitypackagefile-url] 하세요.

### Unity version info - Unity 버전 관련 정보

This project was built and tested on Unity 2020.3.28f1 version. Use the corresponding version of Unity or any version above.
...
<!-- USAGE EXAMPLES -->
## Usage - 사용법
- Before using it, look through the sample scenes in Sample Scenes folder.
- asic game control is available with facial expressions (anger, happiness, surprise, etc.) and the direction of the face.

1. Create a Canvas and place SmileFaceAnalyzer Prefab in the Prefabs folder. 
2. Check out the FaceControllerExample script in Scripts folder, copy the FaceControllerTemplate script, and write the controller code for the game.
3. Create the object of control and place the controller script written in step2. 
...
<!-- CONTRIBUTING -->
## How to Contribute - 프로젝트에 기여하기

SmileFace SDK is open to any suggestions and ideas for additional features on making more people enjoy game. 
To contribute to this project with improved script code please follow the instruction below.
...
- For development and Collaboration: cowcowwow@icloud.com
- For Collaboration with Smilegate: sg_creative@smilegate.com 

- 개발&협업 관련 문의  : [cowcowwow@icloud.com](mailto:cowcowwow@icloud.com) 
